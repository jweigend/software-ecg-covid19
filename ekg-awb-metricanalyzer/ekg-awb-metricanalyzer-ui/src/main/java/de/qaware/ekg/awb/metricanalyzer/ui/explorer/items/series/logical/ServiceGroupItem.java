...
public class ServiceGroupItem extends ContextAwareItem {

    /**
     * Creates a new ServiceGroup item based on the given context and the project
     *
     ...
     */
    public ServiceGroupItem(String label, FilterContext context, EkgRepository repository) {
        super(label, context, repository);
        super.setGraphic(getIconProvider().getServiceGroupItemIcon(this));
    }

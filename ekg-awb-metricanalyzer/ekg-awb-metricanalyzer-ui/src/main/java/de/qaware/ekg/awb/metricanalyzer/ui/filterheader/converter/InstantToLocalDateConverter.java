 ...
 * of the given day. If want to set a different time use the {@link InstantToLocalDateConverter#InstantToLocalDateConverter(LocalTime)}
...
public class InstantToLocalDateConverter implements Converter<Instant, LocalDate> {
     ...
     */
    public InstantToLocalDateConverter() {
     ...
     */
    public InstantToLocalDateConverter(LocalTime targetTime) {
    ...
    public LocalDate fromFirst(Instant first) {
        ...
        return LocalDateTime.ofInstant(first, CET).toLocalDate();
    }
    ...
    public Instant fromSecond(LocalDate second) {
        ...
        return second.atTime(targetTime).atZone(CET).toInstant();
    }
}
